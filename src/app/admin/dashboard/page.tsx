...
/**
 * Admin Dashboard - Control Center for staff management and analytics.
 * MVC: Fetches from admin API, displays charts and staff table.
 */
        ...
        >
              ...
              {analyticsLoading ? (
                ...
                <>
                  ...
                  <StatCard
                    ...
                    value={`$${analytics.simulatedRevenue}`}
                    icon={DollarSign}
                    index={3}
                  />
                </>
                          ...
                          >
                            ...
                            <td className="py-3 text-right">
                              <button
                                type="button"
                                onClick={() =>
                                  removeStaffMutation.mutate(s._id)
                                }
          ...
          <AddStaffModal
            ...
            onSubmit={(email, password) =>
              addDoctorMutation.mutateAsync({ email, password })
            }
            error={modalError}
          ...
          <AddStaffModal
            ...
            onClose={() => {
              setReceptionistModalOpen(false);
              setModalError(null);
            }}
            role="receptionist"
            onSubmit={(email, password) =>
              addReceptionistMutation.mutateAsync({ email, password })
            }
            error={modalError}
            onClearError={() => setModalError(null)}
          />
